    ...
    <div id="new-post-container" class="mt-5">
        <form id="new-post-form" class="d-flex flex-column justify-content-center m-auto" method="POST" enctype="multipart/form-data">
            <div class="d-flex flex-column">
                ...
                <textarea id="new-post-textarea" class="form-control mb-2 rounded new-post-textarea" name="post_content" placeholder="Create a new post" rows="2" maxlength="250"required></textarea>
